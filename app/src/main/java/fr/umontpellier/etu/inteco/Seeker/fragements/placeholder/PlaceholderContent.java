package fr.umontpellier.etu.inteco.Seeker.fragements.placeholder;
...
public class PlaceholderContent {
    ...
    private static Offer createPlaceholderItem(int position) {
        return new Offer();//PlaceholderItem(String.valueOf(position), "Item " + position, makeDetails(position));
    }
